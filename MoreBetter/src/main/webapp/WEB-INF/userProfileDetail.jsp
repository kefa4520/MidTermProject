...
<body>
	<div class="container">
	    ...
	    <input type="text"placeholder="yes or no"  name="role" 	value="${user.role}" required><br>
	     --%>
			<label for="role"><b>Applying to be a Mentor?</b></label> <select
				id="role" name="role" required>
				<option value="${user.role}">keep original status</option>
				<option value="STANDARD">no</option>
				<option value="MENTOR">yes</option>
			</select><br> <br> <label for="age"><b>Age</b></label> <input
				type="text" placeholder="enter age" name="age" value="${user.age}"><br>

			<label for="biography"><b>Tell us about yourself</b></label> <input
				type="text" placeholder="enter biography" name="biography"
				value="${user.biography}"><br> <label for="picture"><b>insert
					a picture</b></label> <input type="text" placeholder="insert photo URL here"
				name="picture" value="${user.picture}"><br>
			...
			<button type="submit" class="saveProfileChangesbtn">Save
				Profile Changes for ${user.username}</button>
		</form>
	</div>
	...
	<div>
		<form action="destroyProfile.do" method="POST">
			...
			<button type="submit" class="deletebtn">Delete
