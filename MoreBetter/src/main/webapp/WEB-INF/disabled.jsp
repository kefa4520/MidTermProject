...
<div class="jumbotron jumbotron-fluid">
  <div class="container">
    <h1 class="display-3" style="text-align:center">Your Account was Disabled</h1>
    <p class="lead" style="text-align:center">Please email us at morebetter@gmail.com to re-activate your account!</p>
  </div>
</div>
