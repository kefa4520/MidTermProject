...
START TRANSACTION;
USE `morebetterdb`;
INSERT INTO `user` (`id`, `first_name`, `last_name`, `email`, `role`, `age`, `username`, `password`, `enabled`, `picture`, `biography`) VALUES (1, 'Jeff', 'Lopez', 'jeff.o.admin@user.mail', 'MENTOR', 34, 'jefflopez', 'jefflopez', 1, NULL, NULL);
...
INSERT INTO `user` (`id`, `first_name`, `last_name`, `email`, `role`, `age`, `username`, `password`, `enabled`, `picture`, `biography`) VALUES (4, 'Steve', 'Sharp', 'dude.admin@user.mail', 'MENTOR', 34, 'stevies', 'stevies', 1, NULL, NULL);
...
INSERT INTO `user` (`id`, `first_name`, `last_name`, `email`, `role`, `age`, `username`, `password`, `enabled`, `picture`, `biography`) VALUES (6, 'Rich', 'Roll', 'roll.admin@user.mail', 'MENTOR', 30, 'richroll', 'richroll', 1, NULL, NULL);
INSERT INTO `user` (`id`, `first_name`, `last_name`, `email`, `role`, `age`, `username`, `password`, `enabled`, `picture`, `biography`) VALUES (7, 'Iryna', 'T', 'i.ryna.admin@user.mail', 'MENTOR', 31, 'irynatr', 'irynatr', 1, NULL, NULL);
INSERT INTO `user` (`id`, `first_name`, `last_name`, `email`, `role`, `age`, `username`, `password`, `enabled`, `picture`, `biography`) VALUES (8, 'Anna', 'Smith', 'a.smith.admin@user.mail', 'STANDARD', 28, 'annasmith', 'annasmith', 1, NULL, NULL);
COMMIT;
...
START TRANSACTION;
USE `morebetterdb`;
INSERT INTO `event` (`id`, `category_id`, `mentor_id`, `address_id`, `title`, `description`, `location`, `event_date`, `max_capacity`, `price`, `created_at`, `last_updated`) VALUES (1, 1, 1, NULL, 'Social Media Online Summit 2020', 'Social media marketing changes FAST. And that is why every year, since 2018, thousands of entrepreneurs and marketers sign up for Social Media Online Summit to lear the latest, the hottest, and what is actually working RIGHT NOW in social media marketing.', 'Online Conference', '2020-08-19 01:00:00', 200, 0.00, '2020-04-16 08:50:58', NULL);
...
START TRANSACTION;
USE `morebetterdb`;
INSERT INTO `article` (`id`, `category_id`, `mentor_id`, `title`, `contents`, `created`, `reference`) VALUES (1, 1, 1, 'Do you have a long-term plan ', 'Despite the recent recovery in the market, stocks remain down by more than 12% from the February peak, and about 9% year-to-date. Meanwhile, the story for the first three weeks of May has been one of running in place.', '2020-04-10 10:25:30', 'https://careerwise.minnstate.edu/mymncareers/finish-school/long-short-goals.html');
